                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 section">
                                ...
                                <a href="https://github.com/agopdev" target="_blank" rel="noreferrer" className="social-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16" style={{margin: '15px'}}>
                                ...
                                <a href="https://linkedin.com/in/agopdev" target="_blank" rel="noreferrer" className="social-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" className="bi bi-linkedin" viewBox="0 0 16 16" style={{margin: '15px'}}>
